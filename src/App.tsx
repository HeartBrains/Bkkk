...
export default function App() {
  ...
  const handleNavigate = (page: string, slug?: string, sectionId?: string) => {
      ...
      if (detailPages.includes(page)) {
          ...
          // Always set the slug when navigating to a detail page, even if undefined
          // This ensures we clear any previous slug
          setSelectedSlug(slug);
      } else if (slug) {
          // For non-detail pages, only set slug if provided
          setSelectedSlug(slug);
      }
    ...
    <LanguageProvider>
      <div className="min-h-screen bg-white font-sans text-black selection:bg-black selection:text-white">
        ...
        <main>
          ...
          {currentPage === 'exhibition-detail' && <ExhibitionDetailPage onNavigate={handleNavigate} slug={selectedSlug || "nine-plus-five-works"} backPage={backPage} />}
          ...
          {currentPage === 'artist-detail' && <ArtistDetailPage onNavigate={handleNavigate} slug={selectedSlug || "eduardo-williams"} backPage={backPage} />}
